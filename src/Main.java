    ...
    public static void reserveRoom(Scanner sc, Statement st) {
        try {
            ...
            try {
                ...
                throw new RuntimeException("Room number might already be reserved");
            }
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    public static void checkRoomNumber(Scanner sc, Statement stm) {
        try {
            ...
            if (rs.next()) {
                ...
                System.out.println();
                System.out.println("Room number for \"reservation ID: " + check_id + "\" with \"Guest: " + guest_name + "\" is at : " + room_num);
                System.out.println();
            } else {
